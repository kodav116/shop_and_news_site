...
urlpatterns = [
    ...
    path('newspaper/news/', NewsFormView.as_view()),
    path('newspaper/comment/', CommentaryFormView.as_view()),
    path('newspaper/news_list/', NewsList.as_view()),
    path('newspaper/<int:pk>/', NewsList.newsdetail, name='newsdetail'),
    path('newspaper/edit/<int:pk>/', UpdateNewsView.as_view(), name='update_news'),
    path('newspaper/login/', login_view, name='login'),
    path('newspaper/logout/', logout_view, name='logout'),
    path('newspaper/another_login/', AnotherLoginView.as_view(), name='another_login'),
    ...
    path('newspaper/update_user/<int:pk>/', UpdateUserView.as_view(), name='update_user'),
