...
class MainView(View):
    ...
    def get(self, request):
        return render(request, 'newspaper/main.html')
...
class NewsFormView(View):
    ...
    def get(self, request):
        news_form = NewsForm()
        return render(request, 'newspaper/news.html', context={'news_form': news_form})
...
class CommentaryFormView(View):
    ...
    def get(self, request):
        ...
        return render(request, 'newspaper/comment.html', context={'comment_form': comment_form})
    ...
    def newsdetail(request, pk):
        ...
        if request.user.is_authenticated:
            ...
            if form.is_valid():
                ...
                comment.news_report = news_report
                comment.save()
        return render(request, 'newspaper/news_report.html', {'news_report': news_report,
...
class UpdateNewsView(UpdateView):
    model = News
    template_name = 'newspaper/update_news.html/'
    fields = ['title', 'description']


class UpdateUserView(UpdateView):
    model = User
    template_name = 'newspaper/update_profile.html/'
...
def login_view(request):
    if request.method == 'POST':
        ...
        return render(request, 'newspaper/login.html', context=context)


class AnotherLoginView(LoginView):
    template_name = 'newspaper/login.html'
